...
*ВАЖНОЕ УТОЧНЕНИЕ* *Если в вы видите IPv4 адрес, который имеет в конце 0, например 10.145.145.0, 10.145.145.10 вам нужно изменить ваш публичный и приватный ключ на ПК, сделать это можно через майнер IP адресов для yggdrasil - [ТЫК]([http://sabaka.net](https://notabug.org/acetone/SimpleYggGen-CPP))*
